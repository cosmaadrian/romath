...
def _make_comparison_question(context, left, right):
  ...
  if random.choice([False, True]) and sympy.Ne(left.value, right.value):
    ...
    if random.choice([False, True]):
      ...
      template = random.choice([
          ...
          'Care dintre numere este mai mare: {left} sau {right}?',
          'Ce număr este mai mare: {left} sau {right}?',
      ])
    else:
      answer = (
      ...
      template = random.choice([
          ...
          'Care dintre numere este mai mic: {left} sau {right}?',
          'Ce număr este mai mic: {left} sau {right}?',
      ])
  ...
  templates = {
      '<': [
          ...
          'Este {left} ' + ops.LT_SYMBOL + ' {right}?',
          'Este adevărat că {left} ' + ops.LT_SYMBOL + ' {right}?',
          'Este {left} mai mic decât {right}?',
      ],
      '<=': [
          ...
          'Este {left} ' + ops.LE_SYMBOL + ' {right}?',
          'Este adevărat că {left} ' + ops.LE_SYMBOL + ' {right}?',
          'Este {left} mai mic sau egal decât {right}?',
          'Este {left} cel mult cât {right}?',
          'Este {left} cel mult la fel de mare ca {right}?',
      ],
      '>': [
          # 'Is {left} ' + ops.GT_SYMBOL + ' {right}?',
          # 'Is {left} greater than {right}?',
          # 'Is {left} bigger than {right}?',
          'Este {left} ' + ops.GT_SYMBOL + ' {right}?',
          'Este adevărat că {left} ' + ops.GT_SYMBOL + ' {right}?',
          'Este {left} mai mare decât {right}?',
          'Este adevărat că {left} mai mare decât {right}?',
      ],
      '>=': [
          ...
          'Este {left} ' + ops.GE_SYMBOL + ' {right}?',
          'Este adevărat că {left} ' + ops.GE_SYMBOL + ' {right}?',
          'Este {left} cel puțin cât {right}?',
          'Este {left} cel puțin la fel de mare ca {right}?',
      ],
      '=': [
          ...
          'Este {left} ' + ops.EQ_SYMBOL + '{right}?',
          'Este adevărat că {left} ' + ops.EQ_SYMBOL + ' {right}?',
          'Este adevărat că {left} este egal cu {right}?',
          'Au numerele {left} și {right} aceeași valoare?',
          'Sunt numerele {left} și {right} egale?',
          'Este {left} egal cu {right}?',
      ...
      '!=': [
          ...
          'Sunt numerele {left} și {right} diferite?',
          'Au numerele {left} și {right} valori diferite?',
          'Au numerele {left} și {right} valori inegale?',
      ],
  }
...
def _kth_biggest_list_question(context, entities, adjective, answer):
  ...
  question = example.question(
      ...
      'Care este {adjective} număr dintre numerele ' + values_template + '?',
...
def _kth_biggest_multichoice_question(context, entities, adjective, answer):
  ...
  question = example.question(
      ...
      'Care este {adjective} număr?' + choices_template,
      adjective=adjective, **entity_dict)
...
def kth_biggest(sample_args, count=None):
  ...
  if random.choice([False, True]):
    ...
    # adjective = 'biggest'
    adjective = 'cel mai mare'
  else:
    # Do from smallest.
    answer = sorted_entities[ordinal - 1]
    # adjective = 'smallest'
    adjective = 'cel mai mic'
...
def _closest_in_list_question(context, entities, target, adjective, answer):
  ...
  question = example.question(
      ...
      'Care este {adjective} valoare față de {target} dintre numerele ' + values_template + '?',
...
def _closest_multichoice_question(context, entities, target, adjective, answer):
  ...
  question = example.question(
      context,
      'Care este {adjective} valoare față de {target}?' + choices_template,
...
def closest(sample_args, count=None):
  ...
  adjective = random.choice(['cea mai apropiată'])
...
def sort(sample_args, count=None):
  ...
  templates = [
      ...
      'Sortează numerele ' + unsorted_template + ' în ordine {direction}.',
      'Sortează ' + unsorted_template + ' în ordine {direction}.',
      'Sortați numerele ' + unsorted_template + ' în ordine {direction}.',
      'Sortați ' + unsorted_template + ' în ordine {direction}.',

      'Pune numerele ' + unsorted_template + ' în ordine {direction}.',
      'Pune ' + unsorted_template + ' în ordine {direction}.',

      'Puneți numerele ' + unsorted_template + ' în ordine {direction}.',
      'Puneți ' + unsorted_template + ' în ordine {direction}.',
  ]
  if ascending:
    templates.append('Sortează numerele ' + unsorted_template + '.')
    templates.append('Sortează ' + unsorted_template + '.')
    templates.append('Sortați numerele ' + unsorted_template + '.')
    templates.append('Sortați ' + unsorted_template + '.')
    # direction = random.choice(['ascending', 'increasing'])
    direction = random.choice(['crescătoare'])
  else:
    direction = random.choice(['descrescătoare'])
