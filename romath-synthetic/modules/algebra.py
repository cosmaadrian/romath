...
def polynomial_roots(value, sample_args, context=None):
  ...
  if random.choice([False, True]):
    ...
    template = random.choice([
        ...
        'Rezolvă {equality}.',
        'Rezolvați {equality}.',
        'Rezolvă ecuația {equality}.',
        'Rezolvați ecuația {equality}.',

        'Determină valoarea lui {variable}, dându-se {equality}.',
        'Determinați valoarea lui {variable}, dându-se {equality}.',
        'Determină valoarea lui {variable}, așa încât {equality}.',
        'Determinați valoarea lui {variable}, așa încât {equality}.',

        'Găsește valoarea lui {variable}, așa încât {equality}.',
        'Găsiți valoarea lui {variable}, așa încât {equality}.',
        'Găsește valoarea lui {variable}, dându-se {equality}.',
        'Găsiți valoarea lui {variable}, dându-se {equality}.',

        'Fie {equality}. Găsiți valoarea lui {variable}.',
        'Fie {equality}. Găsește valoarea lui {variable}.',
        'Fie {equality}. Află valoarea lui {variable}.',
        'Fie {equality}. Aflați valoarea lui {variable}.',
        'Fie {equality}. Calculați valoarea lui {variable}.',
        'Fie {equality}. Calculează valoarea lui {variable}.',
        'Fie {equality}. Calculează valoarea lui {variable}.',
        'Fie {equality}. Calculați valoarea lui {variable}.',

        'Presupunem că {equality}. Găsiți valoarea lui {variable}.',
        'Presupunem că {equality}. Găsește valoarea lui {variable}.',
        'Presupunem că {equality}. Află valoarea lui {variable}.',
        'Presupunem că {equality}. Aflați valoarea lui {variable}.',
        'Presupunem că {equality}. Calculați valoarea lui {variable}.',
        'Presupunem că {equality}. Calculează valoarea lui {variable}.',
        'Presupunem că {equality}. Calculează valoarea lui {variable}.',
        'Presupunem că {equality}. Calculați valoarea lui {variable}.',

        'Care este valoarea lui {variable} în {equality}?',
        'Cât este valoarea lui {variable} în {equality}?',
        'Cât este {variable} în {equality}?',
    ])
    ...
    template = random.choice([
        'Factorizați {expression}.',
        'Factorizează {expression}.',
    ])
    return example.Problem(
...
def _solve_linear_system(degree, value, sample_args, context=None):
  ...
  if is_question:
    template = random.choice([
        ...
        'Află valoarea lui {variable} din ecuațiile {equations}.',
        'Aflați valoarea lui {variable} din ecuațiile {equations}.',
        'Rezolvați ecuațiile {equations} pentru a găsi valoarea lui {variable}.',
        'Rezolvă ecuațiile {equations} pentru a găsi valoarea lui {variable}.',
        'Găsește valoarea lui {variable} din ecuațiile {equations}.',
        'Dându-se ecuațiile {equations}, găsiți valoarea lui {variable}.',
    ])
    return example.Problem(
        example.question(
...
def sequence_next_term(min_entropy, max_entropy):
  ...
  template = random.choice([
      ...
      'Ce urmează în {sequence}?',
      'Care este următorul numar în {sequence}?',
      'Care este următorul termen din {sequence}?',
  ])
...
def sequence_nth_term(min_entropy, max_entropy):
  ...
  template = random.choice([
      ...
      'Care este al {variable}-lea termen din {sequence}?',
  ])
