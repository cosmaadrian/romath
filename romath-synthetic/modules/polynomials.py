...
def coefficient_named(value, sample_args, context=None):
  ...
  template = random.choice([
      ...
      'Exprimă {expression} ca {canonical} și calculează {target}.',
      'Exprimați {expression} ca {canonical} și calculați {target}.',
      'Exprimă {expression} în forma {canonical} și calculează {target}.',
      'Exprimați {expression} în forma {canonical} și calculați {target}.',

      'Rearanjează {expression} în forma {canonical} și calculează {target}.',
      'Rearanjați {expression} în forma {canonical} și calculați {target}.',
      'Rearanjează {expression} ca {canonical} și calculează {target}.',
      'Rearanjați {expression} ca {canonical} și calculați {target}.',
...
def evaluate(value, sample_args, context=None):
  ...
  if is_question:
    ...
    return composition.Entity(
        ...
        value=value,
        expression=composed,
        description='Fie {self} definit ca {composed}.',
        composed=composed)
...
def add(value, sample_args, context=None):
  ...
  if is_question:
    ...
    return composition.Entity(
        context=context,
        value=value,
        description='Fie {intermediate} = {composed}.',
...
def expand(value, sample_args, context=None):
  ...
  template = random.choice([
      'Desfaceți parantezele și simplificați expresia {expression}.',
      'Simplificați expresia {expression}.'
  ])
  return example.Problem(
...
def collect(value, sample_args, context=None):
  ...
  if is_question:
    template = 'Simplificați termenii in expresia {unsimplified}.'
    ...
    return composition.Entity(
        ...
        description='Fie {function} = {unsimplified}.',
        function=function,
...
def simplify_power(value, sample_args, context=None):
  ...
  template = random.choice([
      'Simplificați expresia {unsimplified}, presupunând că variabila {variable} este pozitivă.',
  ])
  return example.Problem(
      example.question(
