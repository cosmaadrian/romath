...
JUDGEINFO='--prompt_lang en --judge_model meta-llama/Meta-Llama-3-70B-Instruct'
for filename in "${FILES[@]}"; do
    echo "Evaluating $filename"
    python evaluate.py --output results2/results-llama-70b/ --pred_file $filename $JUDGEINFO
done
