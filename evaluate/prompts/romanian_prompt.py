PROMPT = [
    {
        ...
        "content":
        """
        Asumă-ți rolul unui profesor de matematică responsabil cu evaluarea răspunsurilor studenților în raport cu soluțiile furnizate, care pot include valori exacte, răspunsuri cu alegere multiplă sau aproximări numerice. Întrebarea este furnizată ca: {question}, răspunsul corect este furnizat ca: {true}.
        ...
        ## Formatul Așteptat al Răspunsului: Prezintă răspunsul final cu un scor doar de '1' sau '0'. Nu include nicio altă informație sau explicații suplimentare în răspuns.
