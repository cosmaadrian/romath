...
# Use this to evaluate the proofs
# https://github.com/bentoml/OpenLLM

class ProofJudgeEvaluator:
    def __init__(self, model_name):
        super().__init__()  
        self.model_name = model_name
        
        # TODO Need to open the chat first with `openllm serve llama3:8b` or something similar
        # Check out https://github.com/bentoml/openllm-models

        self.llm_agent = OpenAI(api_key='na', base_url='http://localhost:3000/v1', temperature = 0., top_p = 0.8, max_tokens = 2096)
        self.llm_evaluate_agent = LLMAgent(EVALUATION_PROMPT, self.llm_agent, stream=False)

    def flowing(self, question: str, true: str, prediction: str, has_single_answer: bool = False) -> str:
        # TODO incorporate math_equivalence.py, only call the llm if has_single_answer is False
...
if __name__ == "__main__":
    ...
    evaluation = ProofJudgeEvaluator()
